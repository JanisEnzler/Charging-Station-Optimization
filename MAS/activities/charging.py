...
# fmt: off
RANDOM_SEED = 42
CAR_TANK_SIZE = 50000      # Size of car fuel tanks (Watt Hours)
CAR_TANK_LEVEL = [5000, 25000]   # Min/max levels of car fuel tanks (liters)
REFUELING_SPEED = 20000        # Rate of refuelling car fuel tank (watts)
CAR_INTERARRIVAL = [1, 600]    # Min/max time between car arrivals (seconds)
